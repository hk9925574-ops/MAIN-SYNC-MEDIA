...
export default function PlatformOverview() {
  ...
  return (
    <section id="platform" className="relative w-full min-h-screen bg-[#050506] text-white py-32 px-6 md:px-12 overflow-hidden">
      <motion.div 
      ...
      >
        <motion.header variants={itemVariants} className="mb-24 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24">
          <motion.div variants={itemVariants} className="group relative">
            ...
            <div className="relative border border-white/10 bg-white/5 p-8 rounded-3xl backdrop-blur-sm h-full flex flex-col hover:border-[#D2FF00]/50 transition-colors duration-500">
              <h3 className="text-4xl font-bebas text-white mb-4">Deduplicated <br/><span className="text-[#D2FF00]">Reach</span></h3>
          ...
          <motion.div variants={itemVariants} className="group relative">
            ...
            <div className="relative border border-white/10 bg-white/5 p-8 rounded-3xl backdrop-blur-sm h-full flex flex-col hover:border-[#3FE0FF]/50 transition-colors duration-500">
              <h3 className="text-4xl font-bebas text-white mb-4">Outcomes <br/><span className="text-[#3FE0FF]">Measurement</span></h3>
              <p className="font-sans font-light text-white/60 leading-relaxed">
          ...
          <motion.div variants={itemVariants} className="group relative md:col-span-2">
            ...
            <div className="relative border border-white/10 bg-white/5 p-8 md:p-12 rounded-3xl backdrop-blur-sm h-full flex flex-col md:flex-row gap-8 items-center hover:border-[#FF4B4B]/50 transition-colors duration-500">
              <div className="flex-1">
                <h3 className="text-4xl md:text-5xl font-bebas text-white mb-4">Media <br/><span className="text-[#FF4B4B]">Optimisation</span></h3>
              ...
              <div className="flex-1 w-full bg-[#050506] border border-white/10 rounded-2xl p-6 h-48 relative overflow-hidden flex items-end">
                ...
                <div className="flex justify-between w-full h-full items-end gap-2">
                  {[40, 70, 45, 90, 60, 100, 30].map((h, i) => (
                    <motion.div 
                      key={i} 
                      className="w-full bg-[#FF4B4B]/20 rounded-t-sm relative group-hover:bg-[#FF4B4B]/40 transition-all duration-500" 
                      initial={{ height: 0 }}
